      ...
      >
        ...
        <div id="content" class="prose lg:prose-xl px-2">
          ...
          <small class="text-center block text-md text-gray-800">
            Writer, Rapper &amp; Software Engineer
          </small>
          <p class="text-justify text-lg text-gray-800">
            Hi! My name is Strange Thugg I'm a rapper and a programmer. Welcome to my blog and hope you will stay round as things get interest
          </p>
